...
import { t as parseURL, g as encodePath, d as decodePath, m as hasProtocol, o as isScriptProtocol, q as joinURL, z as withQuery, u as sanitizeStatusCode, h as getContext, $ as $fetch, a as createHooks, c as createError$1, n as isEqual, v as stringifyParsedURL, w as stringifyQuery, s as parseQuery, f as defu } from '../nitro/nitro.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BrP-CtKr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-k8O1UjOm.mjs'));
